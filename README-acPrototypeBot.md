# acPrototype Bot - `acPrototypeBot`
...
3. Give the bot a handle (ex: `acPrototypeBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://acprototype.azurewebsites.net/api/messages`
